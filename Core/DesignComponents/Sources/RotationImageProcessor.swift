...
struct FlipImageProcessor: ImageProcessing {
  func process(_ image: Nuke.PlatformImage) -> Nuke.PlatformImage? {
    return flip(image: image)
  }
  
  var identifier = "com.missingems.mooligan.flipImageProcessor"
  
  private func flip(image: Nuke.PlatformImage) -> Nuke.PlatformImage? {
